<template>
    <div>
        <div class="flex"> <!-- backend -->
            ...
            <div class="bg-orange-300 rounded m-0.5 p-2 flex justify-center text-xs font-medium">
                python
            </div>
            <div class="bg-orange-200 rounded m-0.5 p-2 flex justify-center text-xs font-medium">
                c#
            </div>
        </div>
